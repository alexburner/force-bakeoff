...
let TICK_LIMIT = 10000;
let TICK_BATCH = TICK_LIMIT;
...
const init = (args) => {
    ...
    simulation.stop();
    charge = __WEBPACK_IMPORTED_MODULE_0_d3_force__["b" /* forceManyBody */]();
    link = __WEBPACK_IMPORTED_MODULE_0_d3_force__["c" /* forceLink */](links);
    link.distance(30);
    link.strength(1);
    x = __WEBPACK_IMPORTED_MODULE_0_d3_force__["d" /* forceX */]();
    y = __WEBPACK_IMPORTED_MODULE_0_d3_force__["e" /* forceY */]();
